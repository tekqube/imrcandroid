...
import com.tekqube.about.weatherapp.model.DayForecast;
import com.tekqube.about.weatherapp.model.Location;
import com.tekqube.about.weatherapp.model.Weather;
import com.tekqube.about.weatherapp.model.WeatherForecast;
...
public static WeatherForecast getForecastWeather(String data) throws JSONException  {
		...
		for (int i=0; i < jArr.length(); i++) {
			...
			df.forecastTemp.day = (float) jTempObj.getDouble("temp");
			df.forecastTemp.min = (float) jTempObj.getDouble("temp_min");
			df.forecastTemp.max = (float) jTempObj.getDouble("temp_max");
			df.forecastTemp.night = (float) jTempObj.getDouble("temp");
			df.forecastTemp.eve = (float) jTempObj.getDouble("temp");
			df.forecastTemp.morning = (float) jTempObj.getDouble("temp");
