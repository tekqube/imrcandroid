 ...
 */
package com.tekqube.about.weatherapp.fragment;
...
import com.tekqube.about.weatherapp.WeatherHttpClient;
...
public class DayForecastFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tempView.setText( (int) (Math.round(dayForecast.forecastTemp.min - 275.15)* 1.8 + 32) + "-" + (int) (Math.round(dayForecast.forecastTemp.max - 275.15)* 1.8 + 32 )+"°F");
